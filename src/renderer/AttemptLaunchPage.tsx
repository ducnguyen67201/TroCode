...
import { AttemptControls } from './features/classroom/AttemptControls';
    ...
    <section className="knowledge-page attempt-page">
      ...
      <div className="attempt-layout">
        ...
        <AttemptControls
          ...
          chooseExistingWorkspace={chooseExistingWorkspace}
          attempt={attempt}
          busyAction={busyAction}
          prepareStarterWorkspace={prepareStarterWorkspace}
          workspace={workspace}
          launchDisabled={launchDisabled}
          isLockedForWork={isLockedForWork}
          launch={launch}
